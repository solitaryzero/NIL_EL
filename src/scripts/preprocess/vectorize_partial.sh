python preprocess/vectorize.py \
    ...
    --out_path ../data/partial_vectors/vector_0p \
...
python preprocess/vectorize.py \
    --data_path ../data/processed \
    --nil_type_path ../data/NEL_annotation/NEL_annotated.csv \
    --out_path ../data/partial_vectors/vector_25p \
...
python preprocess/vectorize.py \
    --data_path ../data/processed \
    --nil_type_path ../data/NEL_annotation/NEL_annotated.csv \
    --out_path ../data/partial_vectors/vector_50p \
...
python preprocess/vectorize.py \
    --data_path ../data/processed \
    --nil_type_path ../data/NEL_annotation/NEL_annotated.csv \
    --out_path ../data/partial_vectors/vector_75p \
