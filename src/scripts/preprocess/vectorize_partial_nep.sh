...
#     --out_path /data/zfw/NEL/data/partial_nep_vectors/vector_25p \
...
#     --data_path /data/zfw/NEL/data/processed \
#     --nil_type_path /data/zfw/NEL/data/NEL_annotation/NEL_annotated.csv \
#     --out_path /data/zfw/NEL/data/partial_nep_vectors/vector_50p \
...
#     --data_path /data/zfw/NEL/data/processed \
#     --nil_type_path /data/zfw/NEL/data/NEL_annotation/NEL_annotated.csv \
#     --out_path /data/zfw/NEL/data/partial_nep_vectors/vector_75p \
